...
describe('Integration Test - MeterManagement/MMGroupDownload ', function () {
    this.timeout(50000);
    ...
    it('Test Case - 3', function (done) {
        testSession.post('/MMConfImportConfSave')
            .send({ "configName": "MMConfiguration", "listMeters": ["0000000000000000010400763"], "Action": "Add" })
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
            .expect(200)
            .end(function (err, res) {
    ...
    it('Test Case - 4', function (done) {
        testSession.post('/MMGroupDownload')
            .send({ "configName": "MMConfiguration" })
            .end(function (err, res) {
                var objDet = res.body;
    ...
    it('Test Case - 6', function (done) {
        testSession.post('/MMConfImportConfSave')
            .send({ "configName": "MMConfiguration", "listMeters": ["0000000000000000010400763"], "Action": "Remove" })
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
            .expect(200)
            .end(function (err, res) {
    ...
    it('Test Case - 12', function (done) {
        testSession.post('/MMConfImportConfSave')
            .send({ "configName": "MMConfiguration1", "listHS": ["0000000000000000010400763"], "Action": "Add" })
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
            .expect(200)
            .end(function (err, res) {
    ...
    it('Test Case - 13', function (done) {
        testSession.post('/MMGroupDownload')
            .send({ "configName": "MMConfiguration1" })
            .end(function (err, res) {
                var objDet = res.body;
                expect(objDet).not.to.equal(undefined);
                setTimeout(done, 1500);
    ...
    it('Test Case - 14', function (done) {
        request(app).post('/DownloadConfigurationResponse')
            .send({ "CellID": 14, "MeterID": 31, "Attribute": "METER_DOWNLOAD", "Data": [{ "Status": 0 }] })
            .end(function (err, res) {
                var objDet = res.body;
                //console.log(JSON.stringify(objDet));
                expect(objDet).not.to.equal(undefined);
    ...
    it('Test Case - 16', function (done) {
        testSession.post('/MMConfImportConfSave')
            .send({ "configName": "MMConfiguration1", "listMeters": ["0000000000000000010400763"], "Action": "Remove" })
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
            .expect(200)
            .end(function (err, res) {
